...
const contabilidadMysql = {
    getConfig: () => {
        ...
        // base de datos de contabilidad que nos pasen, no sobre la que figura en parámetros
        // esto forma parte de la modificación para manejar orígenes
        return {
